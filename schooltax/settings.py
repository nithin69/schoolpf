"""
Django settings for kkpackers project.
...
SECRET_KEY = 'r0eoal3q4@ggcarz7+qy(3m3ine5p5@r8+g2%4%)*y=t$1l=gi'
...
WSGI_APPLICATION = 'kkpackers.wsgi.application'
...
if socket.gethostname() == 'vishnu':
    ...
    'default': {
        ...
        'NAME': 'packers',                      # Or path to database file if using sqlite3.
    ...
    ALLOWED_HOSTS = ["www.kkpackersandmoversvizag.com", "kkpackersandmoversvizag.com"]    
    DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'packers',                      # Or path to database file if using sqlite3.
...
#FCM_APIKEY = "AIzaSyD1bcCy5n4rQr51dDjyuisWIl9_jEHuX_E"
